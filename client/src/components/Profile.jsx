...
import {profilePagevalidation} from '../helpers/validate'
  ...
  return (
    ...
    <Toaster position='top-right' reverseOrder={false}></Toaster>
      <div className='flex justify-center items-center h-screen'>
        <div className={`${styles.glass} ${extend.glass}`} style={{width:"35%", paddingTop:'1em'}}>
          <div className='title flex flex-col items-center'>
            <h4 className='text-3xl font-bold'>Profile</h4>
           <span className='py-2 text-l w-2/3 text-center text-gray-500'>You can update the details.</span>
          </div>
